...
== NES RELEASE 0.4.5-nes.patch.1

This branch prepares the immutable internal RELEASE `0.4.5-nes.patch.1` for the Nexus `releases` repository at `http://192.168.131.36:8088/repository/releases`.

Published coordinate:

* `cn.bjca.footstone.bpring.security:bjca-footstone-bpring-security-oauth2-authorization-server:0.4.5-nes.patch.1` (JAR)

Required internal RELEASE dependencies:
